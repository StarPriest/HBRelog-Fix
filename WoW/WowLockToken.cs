...
namespace HighVoltz.HBRelog.WoW
{
	public class WowLockToken : IDisposable
	{
		...
		private System.Diagnostics.Process _launcherProc;
        ...
        private void StartWowProcess()
        {
            ...
            if (_lockOwner.Processsharp != null)
            {
                _lockOwner.Processsharp.Dispose();
                _lockOwner.Processsharp = null;
            }
            _dialogDisplayTimer = null;
            ...
            if (lanchingWoW)
            {
                ...
                _launcherProc = System.Diagnostics.Process.Start(psi);
        ...
        private IntPtr FindWowWindowHandle(System.Diagnostics.Process wowProcess)
        {
            return
		...
		bool IsWoWProcess(System.Diagnostics.Process proc)
		{
			return proc.ProcessName.Equals("Wow", StringComparison.CurrentCultureIgnoreCase);
		}

		bool IsCmdProcess(System.Diagnostics.Process proc)
		{
