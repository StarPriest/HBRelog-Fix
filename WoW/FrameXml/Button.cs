    ...
    public class Button : Frame
    {
        ...
        public ButtonState State
        {
            get
            {
                ...
                var stateInt = WowManager.Processsharp.Memory.Read<int>(Address + Offsets.Button.FlagsOffset) << 28 >> 28;
                if (stateInt != 0)
                {
        ...
        public FontString FontString
        {
            get
            {
                var ptr = WowManager.Processsharp.Memory.Read<IntPtr>(Address + Offsets.Button.FontStringOffset);
        ...
        public Texture HighlightTexture
        {
            get
            {
                var ptr = WowManager.Processsharp.Memory.Read<IntPtr>(Address + Offsets.Button.HighlightTextureOffset);
