...
namespace HighVoltz.HBRelog.WoW.FrameXml
{
    public abstract class Region : ParentedObject
    {
        ...
        public float Bottom
        {
            ...
            {
                float scale = UIScale;
                var bot = WowManager.Processsharp.Memory.Read<float>(Address + Offsets.Region.BottomOffset);
        ...
        public float Left
        {
            ...
            {
                float scale = UIScale;
                var left = WowManager.Processsharp.Memory.Read<float>(Address + Offsets.Region.LeftOffset);
        ...
        public float Top
        {
            ...
            {
                float scale = UIScale;
                var top = WowManager.Processsharp.Memory.Read<float>(Address + Offsets.Region.TopOffset);
        ...
        public float Right
        {
            ...
            {
                float scale = UIScale;
                var right = WowManager.Processsharp.Memory.Read<float>(Address + Offsets.Region.RightOffset);
        ...
        float UIScale
        {
            get { return WowManager.Processsharp.Memory.Read<float>(Address + Offsets.Region.UIScaleOffset); }
        }
    }
}