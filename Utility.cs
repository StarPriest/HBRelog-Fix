...
namespace HighVoltz.HBRelog
{
    internal static class Utility
    {
        ...
        public static bool Is64BitProcess(System.Diagnostics.Process proc)
        {
            bool retVal;
        ...
        public static System.Diagnostics.Process GetChildProcessByName(int parentPid, string processName)
        {
	    ...
	    private static string GetProcessPath(System.Diagnostics.Process proc)
	    {
        ...
        public static bool IsChildProcessOf(int parentPid, System.Diagnostics.Process child)
        {
        ...
        public static uint BaseOffset(this System.Diagnostics.Process proc)
        {
            return (uint) proc.MainModule.BaseAddress.ToInt32();
        }

        public static string VersionString(this System.Diagnostics.Process proc)
        {
        ...
        private static async Task<bool> WaitForProcessToExitAsync(System.Diagnostics.Process process, TimeSpan waitTimespan)
        {
            var sw = Stopwatch.StartNew();
        ...
        public static bool TryGetProcessById(int procId, out System.Diagnostics.Process process)
        {
            try
            {
