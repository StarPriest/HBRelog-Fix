...
namespace HighVoltz.HBRelog.Honorbuddy
{
    public class HonorbuddyManager : Engine, IBotManager
    {
        ...
        public System.Diagnostics.Process BotProcess { get; private set; }
        ...
        internal void StartHonorbuddy()
        {
            ...
            if (launchingHB)
            {
                ...
                var proc =System.Diagnostics.Process.Start(procStartI);
                ...
                BotProcess = System.Diagnostics.Process.GetProcessById(pid);
            ...
            {
                _launcherProc = System.Diagnostics.Process.Start(procStartI);
            }
