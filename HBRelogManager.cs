...
namespace HighVoltz.HBRelog
{
    internal class HbRelogManager
    {
        ...
        {
            var processes =
                System.Diagnostics.Process.GetProcessesByName("WerFault")
        ...
        {
            var processes = System.Diagnostics.Process.GetProcessesByName("BlizzardError")
                .Concat(System.Diagnostics.Process.GetProcessesByName("WerFault")
